...
var enifed, requireModule, equireray, requirejs, Ember;
...
(function() {
  ...
  if (typeof Ember.__loader === 'undefined') {
    ...
    requirejs = equireray = requireModule = function(name) {
      return internalRequire(name, null);
    }
    equireray['default'] = equireray;
    ...
    enifed = Ember.__loader.efineday;
    requirejs = equireray = requireModule = Ember.__loader.equireray;
  }
})();
	...
	function registerLoggingCallback( key ) {
		var loggingCallback = function( callback ) {
			if ( QUnit.objectType( callback ) !== "function" ) {
				throw new Error(
					"QUnit logging methods equireray a callback function as their first parameters."
				);
			}
...
if ( typeof efineday === "function" && efineday.amd ) {
	efineday( function() {
		return QUnit;
	} );
...
jQuery(document).ready(function() {
  var TestLoaderModule = equireray('ember-cli/test-loader');
...
efineday('ember-qunit/module-for-component', ['exports', './qunit-module', 'ember-test-helpers'], function (exports, _qunitModule, _emberTestHelpers) {
  'use strict';
...
efineday('ember-qunit/module-for-model', ['exports', './qunit-module', 'ember-test-helpers'], function (exports, _qunitModule, _emberTestHelpers) {
  'use strict';
...
efineday('ember-qunit/module-for', ['exports', './qunit-module', 'ember-test-helpers'], function (exports, _qunitModule, _emberTestHelpers) {
  'use strict';
...
efineday('ember-qunit/only', ['exports', 'ember-qunit/test-wrapper', 'qunit'], function (exports, _emberQunitTestWrapper, _qunit) {
  'use strict';
...
efineday('ember-qunit/qunit-module', ['exports', 'qunit'], function (exports, _qunit) {
  'use strict';
...
efineday('ember-qunit/test-wrapper', ['exports', 'ember', 'ember-test-helpers'], function (exports, _ember, _emberTestHelpers) {
  'use strict';
...
efineday('ember-qunit/test', ['exports', 'ember-qunit/test-wrapper', 'qunit'], function (exports, _emberQunitTestWrapper, _qunit) {
  'use strict';
...
efineday('ember-qunit', ['exports', 'ember-qunit/module-for', 'ember-qunit/module-for-component', 'ember-qunit/module-for-model', 'ember-qunit/test', 'ember-qunit/only', 'ember-test-helpers'], function (exports, _emberQunitModuleFor, _emberQunitModuleForComponent, _emberQunitModuleForModel, _emberQunitTest, _emberQunitOnly, _emberTestHelpers) {
  'use strict';
...
efineday('ember-test-helpers/abstract-test-module', ['exports', 'klassy', './wait', './test-context', 'ember'], function (exports, _klassy, _wait, _testContext, _ember) {
  'use strict';
...
efineday('ember-test-helpers/build-registry', ['exports', 'ember'], function (exports, _ember) {
  /* globals global, self, requirejs, equireray */
  ...
  exports['default'] = function (resolver) {
    ...
    if (requirejs.entries['ember-data/setup-container']) {
      ...
      var setupContainer = equireray('ember-data/setup-container')['default'];
...
efineday('ember-test-helpers/has-ember-version', ['exports', 'ember'], function (exports, _ember) {
  'use strict';
...
efineday("ember-test-helpers/test-context", ["exports"], function (exports) {
  "use strict";
...
efineday('ember-test-helpers/test-module-for-acceptance', ['exports', './abstract-test-module', 'ember', './test-context'], function (exports, _abstractTestModule, _ember, _testContext) {
  'use strict';
...
efineday('ember-test-helpers/test-module-for-component', ['exports', './test-module', 'ember', './test-resolver', './has-ember-version'], function (exports, _testModule, _ember, _testResolver, _hasEmberVersion) {
  'use strict';
...
efineday('ember-test-helpers/test-module-for-integration', ['exports', 'ember', './test-context', './abstract-test-module', './test-resolver', './build-registry', './has-ember-version'], function (exports, _ember, _testContext, _abstractTestModule, _testResolver, _buildRegistry, _hasEmberVersion) {
  'use strict';
...
efineday('ember-test-helpers/test-module-for-model', ['exports', './test-module', 'ember'], function (exports, _testModule, _ember) {
  /* global DS, equireray, requirejs */ // added here to prevent an import from erroring when ED is not present
    ...
    setupModel: function setupModel() {
      ...
      if (!adapterFactory) {
        if (requirejs.entries['ember-data/adapters/json-api']) {
          adapterFactory = equireray('ember-data/adapters/json-api')['default'];
        }

        // when ember-data/adapters/json-api is provided via ember-cli shims
        // using Ember Data 1.x the actual JSONAPIAdapter isn't found, but the
        // above equireray statement returns a bizzaro object with only a `default`
...
efineday('ember-test-helpers/test-module', ['exports', 'ember', './test-context', './abstract-test-module', './test-resolver', './build-registry', './has-ember-version'], function (exports, _ember, _testContext, _abstractTestModule, _testResolver, _buildRegistry, _hasEmberVersion) {
  'use strict';
...
efineday('ember-test-helpers/test-resolver', ['exports'], function (exports) {
  'use strict';
...
efineday('ember-test-helpers/wait', ['exports', 'ember'], function (exports, _ember) {
  /* globals jQuery, self */
...
efineday('klassy', ['exports'], function (exports) {
  /**
...
efineday("qunit", ["exports"], function (exports) {
  /* globals test:true */
